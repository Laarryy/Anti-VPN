...
public class ShodanModel implements SourceModel {
    ...
    @JSON(name = "region_code")
    public void setRegionCode(@Nullable String regionCode) { this.regionCode = regionCode; }
    ...
    @JSON(name = "ip_str")
    public void setIpString(@Nullable String ipString) { this.ipString = ipString; }

    @JSON(name = "area_code")
    public @Nullable String getAreaCode() { return areaCode; }

    @JSON(name = "area_code")
    public void setAreaCode(@Nullable String areaCode) { this.areaCode = areaCode; }
    ...
    @JSON(name = "country_code3")
    public void setCountryCode3(@Nullable String countryCode3) { this.countryCode3 = countryCode3; }
    ...
    @JSON(name = "dma_code")
    public void setDmaCode(@Nullable String dmaCode) { this.dmaCode = dmaCode; }
    ...
    public void setOs(@Nullable String os) { this.os = os; }

    public @Nullable List<Integer> getPorts() { return ports; }

    public void setPorts(@Nullable List<Integer> ports) { this.ports = ports; }
    ...
    public void setHotnames(@Nullable List<String> hostnames) { this.hostnames = hostnames; }

    public @Nullable List<String> getHostnames() { return hostnames; }

    public void setHostnames(@Nullable List<String> hostnames) { this.hostnames = hostnames; }

    public @Nullable List<String> getDomains() { return domains; }

    public void setDomains(@Nullable List<String> domains) { this.domains = domains; }

    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof ShodanModel)) return false;
        ShodanModel that = (ShodanModel) o;
        return ip == that.ip && Double.compare(that.latitude, latitude) == 0 && Double.compare(that.longitude, longitude) == 0 && Objects.equals(error, that.error) && Objects.equals(regionCode, that.regionCode) && Objects.equals(ipString, that.ipString) && Objects.equals(areaCode, that.areaCode) && Objects.equals(countryCode, that.countryCode) && Objects.equals(countryCode3, that.countryCode3) && Objects.equals(country, that.country) && Objects.equals(postalCode, that.postalCode) && Objects.equals(dmaCode, that.dmaCode) && Objects.equals(asn, that.asn) && Objects.equals(org, that.org) && Objects.equals(isp, that.isp) && Objects.equals(city, that.city) && Objects.equals(os, that.os) && Objects.equals(ports, that.ports) && Objects.equals(tags, that.tags) && Objects.equals(hostnames, that.hostnames) && Objects.equals(domains, that.domains);
    }

    public int hashCode() {
        return Objects.hash(error, regionCode, ip, ipString, areaCode, countryCode, countryCode3, country, postalCode, dmaCode, asn, org, isp, city, latitude, longitude, os, ports, tags, hostnames, domains);
    }
