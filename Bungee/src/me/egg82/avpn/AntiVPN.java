    ...
    private Runnable checkExceptionLimitReached = new Runnable() {
        public void run() {
            if (exceptionHandler.isLimitReached()) {
                swapExceptionHandlers(
                    new GameAnalyticsExceptionHandler("10b55aa4f41d64ff258f9c66a5fbf9ec", "3794acfebab1122e852d73bbf505c37f42bf3f41", version, getServerId(), getDescription().getName()));
            }
