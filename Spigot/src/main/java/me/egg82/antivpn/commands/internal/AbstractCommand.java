...
public abstract class AbstractCommand implements CommandExecutionHandler<BukkitLocalizedCommandSender> {
    ...
    protected final BukkitCommandManager<BukkitLocalizedCommandSender> commandManager;

    protected AbstractCommand(@NotNull BukkitCommandManager<BukkitLocalizedCommandSender> commandManager) {
