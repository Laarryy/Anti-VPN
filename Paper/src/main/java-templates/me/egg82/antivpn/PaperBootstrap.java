...
public class PaperBootstrap extends JavaPlugin {
    ...
    public void onLoad() {
        ...
        try {
            ...
            loadJars(new File(getDataFolder(), "cache"), new TransparentInjectableClassLoader((URLClassLoader)getClass().getClassLoader()));
    ...
    private void loadJars(@NotNull File cacheDir, @NotNull InjectableClassLoader parentLoader) throws IOException, ModelBuildingException {
        JarInjector injector = new JarInjector(cacheDir);

        // Caffeine
        injector.addBuilder(new JarBuilder("com.github.ben-manes.caffeine", "caffeine", "${caffeine.version}")
        ...
        try {
            ...
            injector.addBuilder(new JarBuilder("com.github.luben", "zstd-jni", "${zstd.version}")
                                        .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        }

        // IPAddress
        injector.addBuilder(new JarBuilder("com.github.seancfoley", "ipaddress", "${ipaddress.version}")
                                    .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        ...
        try {
            ...
            injector.addBuilder(new JarBuilder("com.h2database", "h2", "${h2.version}")
                                        .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        }
        ...
        try {
            ...
            injector.addBuilder(new JarBuilder("mysql", "mysql-connector-java", "${mysql.version}")
                                        .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        }

        // RabbitMQ
        injector.addBuilder(new JarBuilder(replace("com{}rabbitmq"), "amqp-client", "${rabbitmq.version}")
                                    .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        injector.addRelocation(new RelocationBuilder("com{}rabbitmq", "me.egg82.antivpn.external").build("{}", "."));

        // Ebean
        injector.addBuilder(new JarBuilder(replace("io{}ebean"), "ebean-core", "${ebean.version}")
                                    .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        ...
        // Javassist
        injector.addBuilder(new JarBuilder("org.javassist", getJavassistPackage(), "${javassist.version}")
                                    .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        ...
        try {
            ...
            injector.addBuilder(new JarBuilder("org.postgresql", "postgresql", "${postgresql.version}")
                                        .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        }
        ...
        try {
            ...
            injector.addBuilder(new JarBuilder("org.xerial", "sqlite-jdbc", "${sqlite.version}")
                                        .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
        }

        // Jedis
        injector.addBuilder(new JarBuilder("redis.clients", "jedis", "${jedis.version}")
                                    .setRepositoryProxy("https://repo.maven.apache.org/maven2", "https://nexus.egg82.me/repository/maven-central/"));
