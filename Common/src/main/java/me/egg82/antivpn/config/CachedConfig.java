...
public class CachedConfig {
    ...
    public @NotNull ImmutableList<@NotNull StorageService> getStorage() {
        return storage;
    }

    private ImmutableList<MessagingService> messaging = ImmutableList.of();

    public @NotNull ImmutableList<@NotNull MessagingService> getMessaging() {
        return messaging;
    }
    ...
    public @NotNull String getMcLeaksKey() {
        return mcleaksKey;
    }

    private String adminPermissionNode = "avpn.admin";

    public @NotNull String getAdminPermissionNode() {
        return adminPermissionNode;
    }

    private String bypassPermissionNode = "avpn.bypass";

    public @NotNull String getBypassPermissionNode() {
        return bypassPermissionNode;
    }
    ...
    public @NotNull String getServerIdString() {
        return serverIdString;
    }

    public static @NotNull CachedConfig.Builder builder() {
        return new CachedConfig.Builder();
    }
    ...
    public static class Builder {
        ...
        public @NotNull CachedConfig build() {
            return values;
        }
    }
}
